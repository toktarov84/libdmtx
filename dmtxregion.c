...
MatrixRegionOrientation(DmtxDecode *dec, DmtxRegion *reg, DmtxPointFlow begin)
{
   ...
   line2p = FindBestSolidLine(dec, reg, /* fTmp.step */ 0, /* line1x.stepNeg */ 0, +1, line1x.angle);

   fTmp = FollowSeek(dec, reg, line1x.stepNeg - 5);
   line2n = FindBestSolidLine(dec, reg, /* fTmp.step */ 0, /* line1x.stepPos */ 0, -1, line1x.angle);
